...
static const int BITGRAM_SIZE = sizeof(bitgram_t);
static const int BITGRAM_BITSIZE = sizeof(bitgram_t) * 8;

typedef bitgram_t ngram_mask_t;
const static int MASK_BITSIZE = sizeof(ngram_mask_t) * 8 -7;
